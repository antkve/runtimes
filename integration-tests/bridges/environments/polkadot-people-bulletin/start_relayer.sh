...
echo -e "Starting polkadot-bulletin finality relayer. Logs available at: $finality_relayer_log\n"
...
echo -e "Starting polkadot-bulletin parachains relayer. Logs available at: $parachains_relayer_log\n"
...
echo -e "Starting polkadot-bulletin messages relayer. Logs available at: $messages_relayer_log\n"
