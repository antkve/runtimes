...
$POLKADOT_BULLETIN_BINARY_PATH build-spec --chain=sc_init.json --raw \
| jq 'if .genesis.runtimeGenesis.patch
    then .genesis.runtimeGenesis.patch.bridgePolkadotGrandpa.owner = "5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY"
    else .
    end'
